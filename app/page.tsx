...
export default async function Home({ searchParams }: HomeProps) {
  ...
  try {
    ...
    error = 'Could not find weather data for that location. Please try another city.';
  }

  return (
    <main className="min-h-screen bg-linear-to-br from-blue-600 via-blue-500 to-teal-400 p-4 md:p-8">
